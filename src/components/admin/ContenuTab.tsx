...
const INITIAL_FIELDS: Fields = {
  ...
  ACCROCHE_HERO: "Déménagement — Votre Ville",
  DESCRIPTION_ENTREPRISE:
    "Votre description d'entreprise. Déménagement résidentiel, entreprise, longue distance — un accompagnement complet et sur mesure.",
  DESCRIPTION_FOOTER: "Votre description courte pour le footer du site.",
  DESCRIPTION_APROPOS:
    "Fondée par Prénom Nom, votre entreprise est née d'une passion pour le déménagement et le service client.",
  DOMAINE: "www.votre-domaine.fr",
  META_TITLE: "Nom de l'Entreprise | Déménageur à Votre Ville",
  META_DESCRIPTION:
    "Déménageur à Votre Ville. Déménagement résidentiel, entreprise, longue distance, international. Devis gratuit.",
  META_KEYWORDS:
    "déménageur, déménagement, garde-meubles, déménagement entreprise, déménagement longue distance",
  FACEBOOK_URL: "",
  INSTAGRAM_URL: "",
  LINKEDIN_URL: "",
  GOOGLE_MAPS_URL: "",
