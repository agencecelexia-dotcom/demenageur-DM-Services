...
const CATEGORIES = [
  ...
  { value: "stockage", label: "Garde-meubles" },
];
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="px-6 py-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-semibold text-neutral-500 uppercase tracking-wide mb-1.5">Volume</label>
                  <input
                    type="text"
                    value={form.volume}
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-neutral-200 px-3 py-2.5 text-sm font-mono focus:border-primary-900 focus:outline-none"
                  placeholder="/images/realisations/projet.jpg"
                />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-neutral-200 px-3 py-2.5 text-sm font-mono focus:border-primary-900 focus:outline-none"
                    placeholder="/images/realisations/avant.jpg"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-neutral-200 px-3 py-2.5 text-sm font-mono focus:border-primary-900 focus:outline-none"
                    placeholder="/images/realisations/apres.jpg"
                  />
                </div>
              </div>
