    ...
    <footer className="bg-primary-900 text-neutral-300">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 flex gap-4">
              {clientConfig.INSTAGRAM_URL && (
                <a href={clientConfig.INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" aria-label="Instagram"
              ...
              {clientConfig.FACEBOOK_URL && (
                <a href={clientConfig.FACEBOOK_URL} target="_blank" rel="noopener noreferrer" aria-label="Facebook"
                  className="text-neutral-400 hover:text-accent-400 transition-colors">
                  <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
              ...
              {clientConfig.LINKEDIN_URL && (
                <a href={clientConfig.LINKEDIN_URL} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
                  className="text-neutral-400 hover:text-accent-400 transition-colors">
                  <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Services */}
          <div>
            <h3 className="mb-5 text-xs font-semibold uppercase tracking-widest text-neutral-400">
              Nos Services
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-neutral-400">
              <li>
                <a href={`tel:${clientConfig.TELEPHONE}`} className="hover:text-accent-400 transition-colors">
                  {clientConfig.TELEPHONE}
                </a>
              </li>
              <li>
                <a href={`mailto:${clientConfig.EMAIL}`} className="hover:text-accent-400 transition-colors">
                  {clientConfig.EMAIL}
                </a>
              </li>
              <li>
                {clientConfig.ADRESSE}<br />
                {clientConfig.CODE_POSTAL} {clientConfig.VILLE}
              </li>
              <li>{clientConfig.HORAIRES}</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-neutral-500">
          <p>&copy; {new Date().getFullYear()} {clientConfig.NOM_ENTREPRISE}. Tous droits réservés.</p>
